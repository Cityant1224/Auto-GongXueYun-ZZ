...
3. 新增了配置项：`remark`，目的是在多用户时为不同用户进行姓名备注，现在的配置文件示例：
   ...
   [
     {
       ...
       "planId": "",
       "randomLocation": true,
       "user-agent": "Dalvik/2.1.0 (Linux; U; Android 12; SM-G9860 Build/RP1A.200720.012) AppName/4.3.2",
       "signCheck": true,
       "country": "中国",
       "province": "xx省",
       "city": "xx市",
